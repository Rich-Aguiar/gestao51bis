	...
	<div class="container">
		...
		<div class="cards">
			<div class="card">
				...
				<button class="button">Arranchar-me</button onclick="location.href='file:///C:/Users/kaue_/OneDrive/%C3%81rea%20de%20Trabalho/51BIS/arranchar_me.html'">Arranchar-me</button>
			</div>
			<div class="card">
				<h2 class="card-title">Consulte seu histório de Arranchamento aqui.</h2>
				<button class="button">Histórico</button>
			</div>
			<div class="card">
				<h2 class="card-title">Cadastre o cardapio da semana aqui.</h2>
				<button class="button">Cadastrar</button>
			</div>
			<div class="card">
				<h2 class="card-title">Modo Furriel - Gerar Vale Total</h2>
